...
if (!function_exists('curl_init')) {
    throw new WhipException('Facebook needs the CURL PHP extension.');
}
if (!function_exists('json_decode')) {
    throw new WhipException('Facebook needs the JSON PHP extension.');
}
 ...
 * @author Naitik Shah <naitik@facebook.com>
 */
class Facebook extends UncachedWhipPlugin
{
    /**
     * Version.
     */
    ...
    public function getAppId() {
        if ( empty($this->appId) )
            if ( empty($this->_config['appId']) )
                throw new WhipException('No App Id found, please set an App ID.');
    ...
    public function getApiSecret() {
        if ( empty($this->apiSecret) )
            if ( empty($this->_config['apiSecret']) )
                throw new WhipException('No API secret key found, please set an API secret key.');
            $this->apiSecret = $this->_config['apiSecret'];
